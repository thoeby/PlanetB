...
async function goesThere(b, drawn) {
    await test.step('B goes there and stands on their own land', async () => {
        ...
        // handed over is its own ground, which has never been rendered: its
        // tiles, dirty, waiting to be submitted — how many depends on where
        // the boundary falls on the tile grid. The panel counts them
