...
-- says so.
--
-- TASKS-foundation.md FND.8. db/0161 made a rule a symbol and pinned the ones
...
-- snapshot names the applied style (db/0161), so an atom built a minute ago
...
-- db/0142's render_pool, saying why a job is there. Everything else about it
-- is unchanged.
