...
-- (db/0163), and two ways of saying the same thing is one too many: what a
...
-- (db/0165). The conversion is a tab's work like every other (Invariant 9):
...
-- Invariant 6: shaping a land is the landholder's, and db/0163 said so in one
...
-- db/0163's save_height_edit, with that one line where the guard was.
