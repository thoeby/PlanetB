-- 0126_thirtythousandtostart.sql — the seed is thirty thousand splats.
--
-- Three eightieths of the budget: 30k on a z14 tile. The rest is brush's to
-- grow where the frames say the picture is wrong, and now that the frames
-- cover the ground from stations (db/0125) it can see where that is.
--
-- db/0125's build_dag, with that one number.
