...
SELECT is((SELECT algo_version FROM t), 'train-v18', 'the trainer is train-v18');
SELECT is((SELECT (params ->> 'iters')::int FROM t), 4000,
    'over 4000 steps: the second half is where splats get small (db/0148)');
