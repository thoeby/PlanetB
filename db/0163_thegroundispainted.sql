...
-- db/0161's tile_world, carrying the shaped ground with the rest of it.
...
-- db/0160's can_write, with the extension a shaped ground is written under.
...
-- db/0151's build_dag, with assemble at `assemble-v11`: everything db/0151 pins
...
-- db/0158's submission_changes, saying whether the ground itself moved. An
