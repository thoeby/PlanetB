...
-- says it in the register call, and it lands in `asset.parts` (db/0159) as
--
...
-- db/0159's register_asset, with the markings in the number.
...
-- db/0157's build_dag, with assemble at `assemble-v8`.
--
...
-- migration moved assemble to `assemble-v8`; merged onto db/0151, which had moved it
